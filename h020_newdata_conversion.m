...
% HOME
mdir = ['D:\x_gdrive\ic_welcom_leap_fm\a98_hometrial_data\' pname];

% OFFICE
% mdir = ['G:\My Drive\ic_welcom_leap_fm\a98_hometrial_data\' pname];
...
num_file = size(data_fname, 2);
hometrial_info = [];

for i = 1 : num_file

    % load the binary data file (*.dat)
    tmp_fname = data_fname{i};
