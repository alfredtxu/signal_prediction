...
for i = 1 : num_files
    ...
    for t = 1 : length(IMU_thresh)

        tmp_IMUa = abs(IMUaccNet_TF{i, :});
        tmp_IMUa_P = tmp_IMUa(abs(tmp_IMUa) >= IMU_thresh(t));
        tmp_IMUa_N = tmp_IMUa(abs(tmp_IMUa) < IMU_thresh(t));
        ...
        tmp_IMUa_map = abs(tmp_IMUa) >= IMU_thresh(t);
        IMUa_map{i, t, :} = imdilate(tmp_IMUa_map, IMU_lse);
        % -----------------------------------------------------------------------------------------------

        tmp_IMUg = abs(IMUgyrNet_TF{i, :});
        tmp_IMUg_P = tmp_IMUg(abs(tmp_IMUg) >= IMU_thresh(t));
        tmp_IMUg_N = tmp_IMUg(abs(tmp_IMUg) < IMU_thresh(t));
        ...
        tmp_IMUg_map = abs(tmp_IMUg) >= IMU_thresh(t);
        ...
        fprintf(['Current data file from %s (%s): %d of %d >> ' ...
                 ...
                 IMU_thresh(t), SNR_IMUa(i, t), SNR_IMUg(i, t), ...
