...
% Notify start of the step
fprintf('\n#Data pre-processing and laoding is going on...');
...
% ~~~~~~~~~~~~ Arrange all the general information in a table ~~~~~~~~~~~~~
T_general_info = table('Size',[n_data_files 4],'VariableTypes',{'string','double','double','double'},...
    'VariableNames',{'Data file','Duration','Force value', 'Sensation detection'});
...
for j = 1:n_data_files
    ...
    T_general_info{j,1} = DFN; % Data file names in the first column
    T_general_info{j,2} = duration_raw_data_files(j); % Duration of raw data file in the second column 
    T_general_info{j,3} = Force_mean(j); % Average force sensor value in the 3rd column
end
