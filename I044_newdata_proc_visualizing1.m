...
for i = 8
    ...
    for j2 = 1 : num_FMsensors
        ...
        tmp_FM_noise = tmp_sensor_indiv(tmp_sensor_indiv < FM_thresh(i, j2));
        tmp_FM_signals = tmp_sensor_indiv(tmp_sensor_indiv >= FM_thresh(i, j2));
        ...
        tmp_FM_segmented = (tmp_sensor_indiv >= FM_thresh(i, j2));
...
%                 i, j2, tmp_sens_map_comp, tmp_sensor_comp, match_indiv_sensation_num_INV(i, j2));
        ...
        nexttile
        hold on;
        plot(tmp_timeV, tmp_sensor_indiv, 'LineWidth', line_width); 
        ylim([0, max(tmp_sensor_indiv)*ylim_multiplier]);
        hold off;
         
        % T2: segmented
        nexttile
        hold on;
        plot(tmp_timeV, tmp_sensor_indiv.*tmp_FM_segmented, 'LineWidth', line_width); 
        ylim([0, max(tmp_sensor_indiv)*ylim_multiplier]);
        hold off;
        ...
        nexttile
        hold on;
        plot(tmp_timeV, tmp_sensor_indiv.*tmp_FM_segmented_dia, 'LineWidth', line_width); 
        ylim([0, max(tmp_sensor_indiv)*ylim_multiplier]);
        hold off;
        ...
        nexttile
        hold on;
        plot(tmp_timeV, tmp_sensor_indiv.*FM_segmented_IMUa{i, j2}, 'LineWidth', line_width); 
        ylim([0, max(tmp_sensor_indiv)*ylim_multiplier]);
        hold off;
        ...
        nexttile
        hold on;
        plot(tmp_timeV, tmp_sensor_indiv.*FM_segmented_IMUg{i, j2}, 'LineWidth', line_width); 
        ylim([0, max(tmp_sensor_indiv)*ylim_multiplier]);
        hold off;
        ...
        nexttile
        hold on;
        plot(tmp_timeV, tmp_sensor_indiv.*FM_segmented_IMUag{i, j2}, 'LineWidth', line_width); 
        ylim([0, max(tmp_sensor_indiv)*ylim_multiplier]);
        hold off;
