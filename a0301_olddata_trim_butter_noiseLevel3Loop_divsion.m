...
for por = 1 : num_p
    ...
    for i = 1 : num_filesP
        ...
        fprintf('Current data file (portion: %d) from %d (%d) ...\n', curr_p, i, num_filesP);
    ...
    cd(fdir);
    save(['Seg01_butter_' group '_' data_category '_P' sprintf('%03d',fidx_s) '_' sprintf('%03d',fidx_e) ...
