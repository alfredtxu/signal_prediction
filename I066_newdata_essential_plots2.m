...
precision_001RB = sum(match_sensorFusion_IMUag_sensation_num) / sum(sensor_IMUag_fusionOR_acouORpiez_comp_001RB);
sensitivity_001RB = sum(match_sensorFusion_IMUag_sensation_num) / sum(sens_mapIMUag_comp_001RB);
...
precision_002JG = sum(match_sensorFusion_IMUag_sensation_num) / sum(sensor_IMUag_fusionOR_acouORpiez_comp_002JG);
sensitivity_002JG = sum(match_sensorFusion_IMUag_sensation_num) / sum(sens_mapIMUag_comp_002JG);

% manual for perfection
match_sensorFusion_IMUag_sensation_num_P = match_sensorFusion_IMUag_sensation_num;
...
precision_002JG_P = sum(match_sensorFusion_IMUag_sensation_num_P) / sum(sensor_IMUag_fusionOR_acouORpiez_comp_002JG_P);
sensitivity_002JG_P = sum(match_sensorFusion_IMUag_sensation_num_P) / sum(sens_mapIMUag_comp_002JG_P);
...
precision_003AM = sum(match_sensorFusion_IMUag_sensation_num) / sum(sensor_IMUag_fusionOR_acouORpiez_comp_003AM);
sensitivity_003AM = sum(match_sensorFusion_IMUag_sensation_num) / sum(sens_mapIMUag_comp_003AM);
...
precision_003AM_P = sum(match_sensorFusion_IMUag_sensation_num_P) / sum(sensor_IMUag_fusionOR_acouORpiez_comp_003AM_P);
sensitivity_003AM_P = sum(match_sensorFusion_IMUag_sensation_num_P) / sum(sens_mapIMUag_comp_003AM_P);
